...
export declare class utils {
     ...
     */
    getAnimeQuerySearchUrl(url: string, query: string, options?: IAnimeSearchOptions): string;
    /**
     ...
     */
    getMangaQuerySearchUrl(url: string, query: string, options?: IMangaSearchOptions): string;
    /**
     ...
     * @param {IAnimeSearchOptions} options The options to use for searching
     */
    getCharacterQuerySearchUrl(url: string, query: string, options?: ICharacterSearchOptions): string;
    /**
