...
import { IAnime, IAnimeCharacters, IAnimeStaff, IAnimeEpisodes, IAnimeEpisodeById, IAnimeNews, IAnimeForum, IAnimeVideos, IAnimePictures, IAnimeStats, IAnimeMoreInfo, IAnimeRecommendations, IAnimeUserUpdates, IAnimeReviews, IAnimeRelations, IAnimeThemes, IAnimeExternal, IAnimeSearch, ITopAnime } from "../typings/anime";
import { IAnimeSearchOptions, ISimpleOption, TAnimeFilter } from "../typings/searchOptions";
export declare class Anime {
     ...
     */
    getAnimeEpisodes(id: number, page?: ISimpleOption): Promise<IAnimeEpisodes>;
    /**
     ...
     * @returns {IAnimeNews}
     */
    getAnimeNews(id: number, options?: ISimpleOption): Promise<IAnimeNews>;
    /**
     ...
     * @returns {IAnimeForum}
     */
    getAnimeForum(id: number, filter?: TAnimeFilter): Promise<IAnimeForum>;
    /**
     ...
     */
    getAnimeUserUpdates(id: number, options?: ISimpleOption): Promise<IAnimeUserUpdates>;
    /**
     ...
     */
    getAnimeReviews(id: number, options?: ISimpleOption): Promise<IAnimeReviews>;
    /**
     ...
     */
    searchAnime(query: string, options?: IAnimeSearchOptions): Promise<IAnimeSearch>;
    /**
     * Method for getting top Anime list
     * @param {ISimpleOption} page The page of the list
     * @returns {ITopAnime}
     */
    getTopAnime(options?: ISimpleOption): Promise<ITopAnime>;
    /**
